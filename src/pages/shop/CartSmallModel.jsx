...
import { removeFromCart, updateQuantity } from "../../redux/features/cart/CarSlice";


const CartSmallModel = ({ products, isOpen, onClose }) => {

  //for the i - and + button to do the functions
  ...
  return (
    <div
      ...
      style={{ transition: "opacity 300s" }}
    >
      <div
        className={`fixed right-0 top-0 md:w-1/3 bg-white h-full overflow-y-auto transition-transform ${isOpen ? "translate-x-0" : "translate-x-full"}`}
        style={{
          ...
          <div className="cart-items">
            {products.length === 0 ? (
              ...
              products.map((item, index) => (
                <div
                  key={index}
                  className="flex flex-col md:flex-row md:items-center  shadow-2xl md:p-5 p-2 mb-4"
                >
                  {" "}
